...
class FirewallManagment extends Model
{
    use HasFactory;
    ...
    public function source_assets(){
        return $this->belongsTo(Location::class,'source_asset', 'id');
    }
    public function destination_assets(){
        return $this->belongsTo(Location::class,'destination_asset', 'id');
    }
