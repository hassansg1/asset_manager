...
class SoftwareForPatchApprovalController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    public function __construct()
    {
        ...
        $this->route = 'software_for_patch_approval';
        $this->heading = 'Software';
        \Illuminate\Support\Facades\View::share('top_heading', 'Sofwares');
    }
