...
class SoftwareComponentController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new SoftwareComponent();
        $this->route = 'software_component';
        $this->heading = 'Software Component';
        \Illuminate\Support\Facades\View::share('top_heading', 'Software Component');
    }
