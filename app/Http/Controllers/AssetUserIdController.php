...
class AssetUserIdController extends Controller
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new AssetUserId();
        $this->route = 'asset_user';
        $this->heading = 'Asset User Id';
        \Illuminate\Support\Facades\View::share('top_heading', 'Asset User Id');
    }
