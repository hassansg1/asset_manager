...
class InstalledPatchesController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    public function __construct()
    {
        ...
        $this->route = 'installed_patch';
        $this->heading = 'Installed Patch';
        \Illuminate\Support\Facades\View::share('top_heading', 'Installed Patches');
    }
    ...
    {
        $save = $this->model->saveFormData($this->model, $request);
