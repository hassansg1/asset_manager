...
class InstalledSoftwareController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    public function __construct()
    {
        ...
        $this->route = 'installed_software';
        $this->heading = 'Installed Software';
        \Illuminate\Support\Facades\View::share('top_heading', 'Installed Softwares');
    }
