...
class PatchPolicyController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new PatchPolicy();
        $this->route = 'patch_policy';
        $this->heading = 'Patch Policy';
        \Illuminate\Support\Facades\View::share('top_heading', 'Patch Policy');
    }
    ...
    public function index(Request $request)
    {
        ...
        return view($this->route . "/index")
            ->with(['items' => $data['items'], 'data' => $data, 'request' => $request, 'route' => $this->route, 'heading' => $this->heading]);
    }
