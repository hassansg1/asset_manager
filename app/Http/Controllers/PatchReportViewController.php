...
class PatchReportViewController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    public function index(Request $request)
    {
        ...
        return view("patch_report_view/index")
            ->with(['items' => $data['items'], 'heading' => 'Patch Report View', 'route' => 'patch_report_view']);
    }
