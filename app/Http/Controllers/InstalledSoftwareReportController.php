...
use App\Repos\InstalledSoftwareReportRepo;
use Illuminate\Contracts\Foundation\Application;
use Illuminate\Contracts\View\Factory;
use Illuminate\Contracts\View\View;
use Illuminate\Http\Request;

class InstalledSoftwareReportController extends BaseController
{
    protected $model;
    protected $repo;
    protected $route;
    ...
    {
        $this->model = new InstalledSoftware();
        $this->repo = new InstalledSoftwareReportRepo();
        $this->route = 'installed_software_report';
        $this->heading = 'Installed Software Report';
        \Illuminate\Support\Facades\View::share('top_heading', 'Installed Software');
    }
