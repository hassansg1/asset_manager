...
class OperatingSystemController extends BaseController
{
    ...
    {
        $this->model = new OperatingSystem();
        $this->route = 'operating_system';
        $this->heading = 'Operating System';
        \Illuminate\Support\Facades\View::share('top_heading', 'Operating Systems');
    }
    ...
    public function index(Request $request)
    {
        ...
        return view($this->route . "/index")
            ->with(['items' => $data, 'data' => $data, 'route' => $this->route, 'heading' => $this->heading]);
    }
