...
class SystemUserIdController extends Controller
{
  protected $model;
  protected $route;
  protected $heading;
  ...
  {
    $this->model = new SystemUserId();
    $this->route = 'system_user';
    $this->heading = 'System User Id';
    \Illuminate\Support\Facades\View::share('top_heading', 'System User Id');
}
