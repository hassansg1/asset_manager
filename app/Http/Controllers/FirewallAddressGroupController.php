...
class FirewallAddressGroupController extends Controller
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new FirewallAddressGroup();
        $this->route = 'firewall_address_group';
        $this->heading = 'Firewall Address Group';
        \Illuminate\Support\Facades\View::share('top_heading', 'Firewall Address Group');
    }
    /**
    ...
    {
        $data = FirewallAddressGroup::paginate();
