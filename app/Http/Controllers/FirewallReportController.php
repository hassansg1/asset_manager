...
use App\Repos\FirewallReportRepo;
use Illuminate\Contracts\Foundation\Application;
use Illuminate\Contracts\View\Factory;
use Illuminate\Contracts\View\View;
use Illuminate\Http\Request;

class FirewallReportController extends BaseController
{
    protected $model;
    protected $repo;
    protected $route;
    ...
    public function __construct()
    {
        ...
        $this->repo = new FirewallReportRepo();
        $this->route = 'firewall_report';
        $this->heading = 'Firewall Report';
        \Illuminate\Support\Facades\View::share('top_heading', 'Firewall');
    }
