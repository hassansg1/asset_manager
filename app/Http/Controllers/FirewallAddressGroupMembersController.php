...
use App\Models\FirewallAddressGroupMembers;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

class FirewallAddressGroupMembersController extends Controller
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new FirewallAddressGroupMembers();
        $this->route = 'firewall_address_group_memeber';
        $this->heading = 'Firewall Address Group Members';
        \Illuminate\Support\Facades\View::share('top_heading', 'Firewall Address Group Memebers');
    }
    /**
    ...
    {
        $data = FirewallAddressGroupMembers::paginate();
