...
use App\Models\SystemUserRight;
use App\Models\System;
use Illuminate\Http\Request;

class SystemUserRightController extends Controller
{
  protected $model;
  protected $route;
  protected $heading;
  ...
  {
    $this->model = new SystemUserRight();
    $this->route = 'system_user_right';
    $this->heading = 'System User Rights';
    \Illuminate\Support\Facades\View::share('top_heading', 'System User Rights');
}
    ...
    public function create()
    {
        ...
        ->with(['route' => $this->route, 'systems' => $system,'heading' => $this->heading]);
    }
