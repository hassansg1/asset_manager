...
use App\Repos\SoftwareReportRepo;
use Illuminate\Contracts\Foundation\Application;
use Illuminate\Contracts\View\Factory;
use Illuminate\Contracts\View\View;
use Illuminate\Http\Request;

class SoftwareReportController extends BaseController
{
    protected $model;
    protected $repo;
    protected $route;
    ...
    public function __construct()
    {
        ...
        $this->repo = new SoftwareReportRepo();
        $this->route = 'software_report';
        $this->heading = 'Software Report';
        \Illuminate\Support\Facades\View::share('top_heading', 'Softwares');
    }
