...
class FirewallZoonController extends Controller
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new FirewallZoon();
        $this->route = 'firewall_zone';
        $this->heading = 'Firewall Zone';
        \Illuminate\Support\Facades\View::share('top_heading', 'Firewall Zone');
    }
    /**
