...
class ZonePolicyController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    {
        $this->model = new ZonePolicy();
        $this->route = 'zone_policy';
        $this->heading = 'Zone Policy';
        \Illuminate\Support\Facades\View::share('top_heading', 'Zone Policy');
    }
