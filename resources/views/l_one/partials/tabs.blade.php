<ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#sim_info" role="tab">
            <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
            <span class="d-none d-sm-block">Sim & WAN info</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" data-bs-toggle="tab" href="#com_info" role="tab">
            <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
...
<div class="tab-content p-3 text-muted">
    ...
    <div class="tab-pane" id="sim_info" role="tabpanel">
        @include('l_one.partials.tabs.sim_info')
    </div>
    <div class="tab-pane active" id="com_info" role="tabpanel">
