        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="{{ isset($item) ? $item->id:'' }}parent" class="form-label required">Unit Parent</label>
                            <select class="form-control select2" name="parent_id" id="{{ isset($item) ? $item->id:'' }}parent" required>
