            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="{{ isset($item) ? $item->id:'' }}name" class="form-label required">Address Group Name</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="{{ isset($item) ? $item->id:'' }}description" class="form-label">Group Description</label>
