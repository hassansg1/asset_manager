<div class="row">
    <div class="col-lg-4">
        <div class="mb-3">
            ...
            <input type="text" value="{{ isset($item) ? $item->name:old('asset_firmware') ?? ''  }}"
    ...
    <div class="col-lg-4">
        <div class="mb-3">
            ...
            <input type="text" value="{{ isset($item) ? $item->name:old('redundant_pair_id') ?? ''  }}"
    ...
    <div class="col-lg-4">
        <div class="mb-3">
            ...
            <input type="text" value="{{ isset($item) ? $item->name:old('asset_contact_person') ?? ''  }}"
